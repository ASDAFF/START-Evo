...
//Start Template tab
mm_createTab('Template','Template', '', $news_tpl, '', '600');
mm_moveFieldsToTab('PageLayout,StartThirdRow,CustomScript', 'Template', '', $news_tpl);

// Start Home nivoslider/flexslider template 
//  $news_tpl = 'id of your StartHome template'; 
$news_tpl = '5';
mm_createTab('Slider','sliderTab', '', $news_tpl, '', '600');
//  replace "nivoslider" with "flexslider" if you use this one
mm_moveFieldsToTab('nivoslider', 'sliderTab', '', $news_tpl);


// Start Page template -  $news_tpl = 'id of your StartPage template';
$news_tpl = '6';
mm_createTab('Gallery','galleryTab', '', $news_tpl, '', '600');
